# Обзор инструментов моделирования. Их установка
...
```
2. Добавить репозиторий Kathara. Можно вручную создать файл /etc/apt/sources.list.d/kathara.list и добавив в него строки, в зависимости от версии Debian [-@tbl-ver]:

: Содержимое файла в соответствии с версией Debian {#tbl-ver}
